select 
    ...
    cast(count(DISTINCT if(t.epd>60 and t.paid_up60<t.monthly_installment_payment,t.installment_order_id)) as double) / count(DISTINCT if(t.epd>60,t.installment_order_id)) poid60s
from (
    select 
