...
select 
    ...
    Case_Group 
from A
where Analyst in ('allan.solichin','agustin.putri','Irma suryani nasution','faizzain.muhammad','saifullah.saputra',
                    'arief','adi.tri','mauren.olivia','Nur.ismail','achmad','dyonisia.anggita','alisa','achmad.rivai',
                    'dessy.astarini','hadi.putra', 'lutfi.fanani')